...
<body>
    ...
    <div class="sidebarContent">
          ...
          <!-- navbar end-->
            ...
            <!-- main content-->
            <div class="main p-2">
                  <h1 class="gray-text"> <i class="fa fa-users"></i> Students Entry</h1>
                  <hr/>
                    <a href="./createstudents.php" class="btn addBtn mb-2"> <i class="fa fa-plus"></i> Create Entry </a>
