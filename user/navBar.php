<nav class="navbar navbar-expand-lg navbar-light " style="background-color:#f1f1f1">
                    <a href="#" class="navbar-brand text-center">
                        <span class="blue-text">ERP System</span>
                    </a>
                <ul class="navbar-nav" style="margin-left:auto">
                    <li class="nav-item mr-3 mt-2" style="font-size:20px;cursor:pointer;">
                            <span class="fa fa-bell" onclick="window.open('http://localhost/erp/user/reminders/todaysReminder.php','_self')"></span><sup> <span class="badge badge-danger">
                            <?php
